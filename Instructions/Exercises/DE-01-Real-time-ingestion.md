...
1. Na saída da primeira célula, use o ícone **+ Código** para adicionar uma nova célula. Em seguida, execute o seguinte código para criar um fluxo com base na pasta que contém os dados do dispositivo JSON:
