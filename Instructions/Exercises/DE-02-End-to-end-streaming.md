...
7. Aguarde a conclusão do script – isso normalmente leva cerca de 5 minutos, mas em alguns casos pode levar mais tempo. Enquanto você aguarda, revise o artigo [Streaming e ingestão incremental](https://learn.microsoft.com/azure/databricks/ingestion/streaming) na documentação do Azure Databricks.
