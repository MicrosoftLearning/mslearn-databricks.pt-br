...
1. Na primeira célula do notebook, insira o código a seguir, que usa comandos *shell* para baixar os dados sobre os pinguins do GitHub no sistema de arquivos do Databricks (DBFS) usado pelo cluster.
