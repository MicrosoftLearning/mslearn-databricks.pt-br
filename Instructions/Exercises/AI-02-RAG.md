...
5. Repita as etapas acima para instalar `databricks-vectorsearch==0.40`também.
...
4. Em uma nova célula, execute o seguinte código para criar um dataframe a partir dos dados brutos:
...
5. Em uma nova célula, execute o código a seguir, substituindo `<catalog_name>` pelo nome do catálogo do Unity (o catálogo com o nome do espaço de trabalho mais um sufixo exclusivo), para limpar e pré-processar os dados para extrair os campos de texto relevantes:
